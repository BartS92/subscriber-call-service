...
public class CallController {
    ...
    public ResponseEntity<CallResponseDto> startCall(@PathVariable Long initPhone, @PathVariable Long receivingPhone) {
    ...
    public ResponseEntity<CallResponseDto> finishCall(@PathVariable Long initPhone, @PathVariable Long receivingPhone) {
        validatePhones(initPhone, receivingPhone);
